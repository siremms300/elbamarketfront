...
import { Menu, X, ArrowRight, Plus, BookOpen } from 'lucide-react';
        ...
        <div className="md:hidden bg-white border-t border-gray-100 shadow-2xl animate-slide-down">
          <div className="px-4 py-6 space-y-1">
            ...
            <Link
              href="/blog"
              onClick={handleMobileLink}
              className="flex items-center gap-2 py-3 px-4 text-sm font-medium text-gray-700 hover:text-elba-primary hover:bg-elba-surface rounded-xl transition-colors"
            >
