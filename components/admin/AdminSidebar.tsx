      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-white/10 flex-shrink-0">
          <Link href="/admin" className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-bold text-sm leading-tight block">Elber</span>
        ...
        {/* Quick Actions */}
        <div className="px-3 pt-4 pb-1 space-y-1">
          <Link
          ...
          <Link
            href="/admin/blog/new"
            onClick={() => setMobileOpen(false)}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium bg-white/10 text-white hover:bg-white/15 transition-all"
          >
