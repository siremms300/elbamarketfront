    ...
    <section className="py-24 lg:py-32 bg-elba-primary relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-8 text-sm text-white/40">
          <span className="flex items-center gap-2"><Shield className="w-4 h-4 text-elba-secondary-light" />Quality verified</span>
          <span className="flex items-center gap-2"><Truck className="w-4 h-4 text-elba-secondary-light" />Nationwide logistics</span>
          <span className="flex items-center gap-2"><Package className="w-4 h-4 text-elba-secondary-light" />Bulk volumes</span>
        </div>
        ...
        <p className="mt-8 text-sm text-white/30">
          No hidden fees · Transparent pricing · Delivery tracking
        </p>
      </div>
    </section>
  );
...
// // client/components/landing/CTASection.tsx
// import Link from 'next/link';
