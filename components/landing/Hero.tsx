...
import { ArrowRight, Shield, Truck, Package, Factory, BarChart3 } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            Trusted by households, processors, manufacturers & exporters
          </div>

          {/* Heading */}
          <h1
            className={`text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white leading-[1.05] transition-all duration-700 delay-100 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            Buy Agricultural Commodities{' '}
            <span className="text-elba-secondary-light">...With Ease</span>
          </h1>
          ...
          >
            ...
            <Link
              href="/register"
              className="group flex items-center gap-2 bg-white/10 hover:bg-white/15 backdrop-blur-sm border border-white/10 hover:border-white/20 text-white font-semibold px-8 py-4 rounded-2xl text-lg transition-all w-full sm:w-auto justify-center"
            >
          ...
          {/* Capability Signals */}
          <div
            className={`flex flex-wrap items-center justify-center gap-6 mt-10 text-sm text-white/50 transition-all duration-700 delay-400 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            <div className="flex items-center gap-2">
              <Shield className="w-5 h-5 text-elba-secondary-light" />
              <span>Verified & quality-tested</span>
            </div>
            <div className="flex items-center gap-2">
              <Truck className="w-5 h-5 text-elba-secondary-light" />
          ...
          {/* Volume Stats */}
          <div
            className={`grid grid-cols-2 sm:grid-cols-4 gap-4 mt-14 transition-all duration-700 delay-500 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            {[
              { value: '10,000+', label: 'Metric Tons Delivered', icon: Package },
              { value: '36', label: 'States Reached', icon: Truck },
              { value: '50+', label: 'Commodities Sourced', icon: BarChart3 },
              { value: '24hrs', label: 'Dispatch Window', icon: ArrowRight },
            ].map((stat) => (
              <div
                key={stat.label}
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 hover:bg-white/10 transition-colors"
              >
                <stat.icon className="w-6 h-6 text-elba-secondary-light mx-auto mb-2" />
